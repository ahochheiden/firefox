...
class ProjectPlugin : Plugin<Project> {
    ...
    override fun apply(project: Project) {
        ...
        configureNativeLibsForTests(project)
    }
    ...
    private fun configureNativeLibsForTests(project: Project) {
        ...
        project.tasks.withType(Test::class.java).configureEach(Action<Test> {
            ...
            testTask.inputs.dir(nativeLibsDir).withPropertyName("nativeLibsForTests")
