...
internal object IntegrityCheckingUniffiLib {
    ...
    external fun uniffi_logins_checksum_method_loginstore_get_checkpoint(
    ): Short
    ...
    external fun uniffi_logins_checksum_method_loginstore_set_checkpoint(
    ): Short
...
external fun uniffi_logins_fn_method_loginstore_get_checkpoint(`ptr`: Long,uniffi_out_err: UniffiRustCallStatus, 
): RustBuffer.ByValue
...
external fun uniffi_logins_fn_method_loginstore_run_maintenance(`ptr`: Long,uniffi_out_err: UniffiRustCallStatus, 
): Unit
external fun uniffi_logins_fn_method_loginstore_set_checkpoint(`ptr`: Long,`checkpoint`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
): Unit
...
public interface LoginStoreInterface {
    ...
    fun `getCheckpoint`(): kotlin.String?
    ...
    fun `setCheckpoint`(`checkpoint`: kotlin.String)
...
open class LoginStore: Disposable, AutoCloseable, LoginStoreInterface
{
    ...
    @Throws(LoginsApiException::class)override fun `getCheckpoint`(): kotlin.String? {
            return FfiConverterOptionalString.lift(
    callWithHandle {
    uniffiRustCallWithError(LoginsApiException) { _status ->
    UniffiLib.uniffi_logins_fn_method_loginstore_get_checkpoint(
        it,
        _status)
}
    }
     ...
     * database.
     */
    @Throws(LoginsApiException::class)override fun `runMaintenance`()
        = 
    callWithHandle {
    uniffiRustCallWithError(LoginsApiException) { _status ->
    ...
    @Throws(LoginsApiException::class)override fun `setCheckpoint`(`checkpoint`: kotlin.String)
        = 
    callWithHandle {
    uniffiRustCallWithError(LoginsApiException) { _status ->
    UniffiLib.uniffi_logins_fn_method_loginstore_set_checkpoint(
        it,
        FfiConverterString.lower(`checkpoint`),_status)
}
    }
